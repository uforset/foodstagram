...
<link rel="stylesheet"
	href="https://www.eyes.co.kr/assets/css/reset.css?v=1669255025">
<link rel="stylesheet"
	href="https://www.eyes.co.kr/assets/css/swiper.min.css">
<link rel="stylesheet"
	href="https://www.eyes.co.kr/assets/css/jquery.mCustomScrollbar.min.css">
<link rel="stylesheet"
	href="https://www.eyes.co.kr/assets/css/site.css?v=1669255025">
...
<script
	src="https://www.eyes.co.kr/assets/js/libs/jquery.mCustomScrollbar.concat.min.js"></script>
		...
		<div class="content">
				...
				<ul class="tbody">
					<c:forEach items="${ list }" var="q" varStatus="status">
						...
						<li>
							...
							<div class="sbj">
								<a href="/foodstagram/qnaDetail.do?q_no=${ q.q_no }">${ q.q_title }</a>
							</div>
							<div class="date">
			...
			<div class="paginate m-hide">
				...
				<c:if
					...
					<a class='prev' href='${ ql2 }' style='cursor: default'
						title='이전그룹'></a>
				</c:if>
				<c:if
					test="${ !((currentPage - 10) <= startPage and (currentPage - 10) >= 1) }">
				...
				<!-- 다음 페이지그룹으로 이동 처리 -->
				<c:if
					test="${ (currentPage + 10) > endPage and (endPage + 1 ) < maxPage }">
					<c:url var="ql3" value="/questionManage.do">
						<c:param name="page" value="${ endPage+1 }" />
					</c:url>
					<a class='next' href='${ ql3 }' style='cursor: default'
						title='다음그룹'></a>
				</c:if>
				<c:if
					test="${ !((currentPage + 10) > endPage and (endPage + 1) < maxPage) }">
			...
			<div class="paginate p-hide">
				<a class='first'
					href='https://www.eyes.co.kr//customer/inquiry_list/?biz_gb=MV&s_keyword=&current_page=1'
					title='처음'></a><a class='prev' href='#' style='cursor: default'
					title='이전'></a><a class='curr' href='#'>1</a><a class='next'
					href='#' style='cursor: default' title='다음'></a><a class='last'
					href='https://www.eyes.co.kr//customer/inquiry_list/?biz_gb=MV&s_keyword=&current_page=1'
					title='마지막'></a>
			</div>
		</div>
