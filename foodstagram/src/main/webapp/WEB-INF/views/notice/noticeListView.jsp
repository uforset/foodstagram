		...
		<div id="scontainer00">
			<div class="s_container">
				<ul class="stab">
					...
					<input type="submit" value="전체목록" class="btn2">
					</a>
				</ul>
				<!-- 항목별 검색 기능 추가 -->
				<div id="board_area">
						...
						<table cellpadding="0" cellspacing="0" class="free_board" summary="" border="0">
							...
							<tbody>
								...
								<c:forEach items="${ requestScope.list }" var="n">
									<tr align="center">
										<td align="center">
										<c:if test="${ n.importance eq 1 }">${ n.noticeno }</c:if>
										<c:if test="${ n.importance eq 2 }"><img src="${ pageContext.servletContext.contextPath }/resources/notice_img/notice.png"></c:if>
										</td>
						...
						<center>
							...
							<ul class="write_btn">
								<c:if test="${ sessionScope.loginMember.admin eq 'Y' }">
									<a
										href="${ pageContext.servletContext.contextPath }/movewrite.do">
										<%-- <img
